<?php 
    ...
    {
      $query="select * from tbl_centre where status='1';";
  ...
  <section class="home-section">
    ...
    <div class="container">
      <table>
        <thead>
          <tr>
            <th colspan="4"><b>Vaccination Centre Details</b><a href="centre.php"><button class="add-btn"> &nbsp;<i
                    class='bx bx-plus'>Add Details</i></button></a></th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      while ($row=mysqli_fetch_array($re))
      {
        ...
        ?>
          <tr>
            ...
            <td><a href='CentreDetails.php?id=<?php echo $row['centre_id']; ?>'> <button
                  class="view-btn">View</button></a>
              <a href='remove.php?id=<?php echo $row['centre_id']; ?>'><button class="delete-btn">Delete</button></a>
            </td>
          </tr>
          <?php
      }
