<?php 
    ...
    {
      $query="select * from tbl_vaccine where status='1';";
...
<body>
  ...
  <section class="home-section">
    ...
    <table>
        <thead>
        <tr>
                <th colspan="3"><b>Vaccine Details</b><a href="vaccine.php"><button  class="add-btn"> &nbsp;<i class='bx bx-plus'>Add Vaccine</i></button></a></th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
              <td><?php echo  $i++; ?></td>
                <td> <?php echo $row['vaccine'] ;?></td>
                   <td>
                    <a href='remove.php?vacc_id=<?php echo $row['vaccine_id']; ?>'><button class="delete-btn">Delete</button></a>
                </td>
            </tr>
          <?php
      }
