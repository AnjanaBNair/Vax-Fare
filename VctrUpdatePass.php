<?php
  ...
  if(isset($_SESSION['uid']))
	...
	if(isset($_POST["submit"]))
	{
		...
		$ps=$_POST["pass1"];
		$query="update tbl_login set password='$ps' where id='$lid'" ;
    ...
    <div class="container">
      <form method="post">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="password" placeholder="Enter Current Password" name="pass3" id="p1" onkeyup="checkpass()"
              required />
            <span>
              <p id="availability"></p>
            </span>
        ...
        <div class="row">
          ...
          <div class="col-75">
            ...
            <span>
              <p id="error2"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;minimum 8
                  characters like letters,digits and one special character</b></p><br>
            </span>
          </div>
        </div><br>
        ...
        <div class="row">
          ...
          <div class="col-75">
            ...
            <span>
              <p id="error3"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Password Doesn't
                  Match</p><br>
            </span>
          </div>
        </div>
