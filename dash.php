...
<body>
  ...
  <form action="/action_page.php">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="vaccine" name="vaccine" placeholder="Vaccine Name">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      <div class="col-25">
        <label for="desc">Vaccine Information</label>
      </div>
      <div class="col-75">
        <textarea id="desc" name="desc" placeholder=" Vaccine Infromation " style="height:100px"></textarea>
      </div>
    </div>
    <div class="row">
