...
// Database conection 
$new_id=$_GET["new_id"];
//Check for conection error
if($con->connect_error){
  die("Error in DB conection: ".$con->connect_errno." : ".$con->connect_error);    
}
...
$select2 = "SELECT * FROM tbl_schedule where book_id='$new_id' and status=0 ORDER BY book_id ASC LIMIT 1;";
...
$pdf->Cell(0,5,'Succesfully First Dose is Vaccinated',0,1,'C');
$pdf->Ln();
...
$pdf->Cell(0, 10, 'Partially Vaccinated ( Dose 1 )', 0, 1, 'L');
$pdf->Ln();
