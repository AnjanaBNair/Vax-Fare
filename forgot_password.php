  ...
  function send_password_mail($email, $token)
  {
    ...
    try {
      ...
      $mail->Body    = "Your Password Reset Link
                        <a href='http://localhost:8080/miniproject/change_password.php?email=$email&token=$token'>Click Here</a>";
      $mail->send();
      return true;
  } catch (Exception $e) {
...
<body>
    ...
    <form method="post">
          ...
          <div class="row">
            <div class="col-25">
              <label for="pass1">Enter Email-ID</label>
            </div>
            <div class="col-75">
            <input type="email" placeholder="Enter Email ID" name="email" id="p1" required/>
              <span>
              <p id="error1"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Email
              </p>
              </span>
            </div>
          </div><br>
          <div class="row">
            <br>
            <input type="submit" name="check_mail" value="Send" class="submit" value="Submit">
          </div>
        </form>
      </div>
      </div>
