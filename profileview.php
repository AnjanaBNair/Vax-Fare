...
if(isset($_SESSION["uid"]))
  ...
  $query1 = "select * from tbl_user where lid='$id';";
...
<div class="sidebar">
  ...
  <section class="home-section">
    ...
    <div class="container">
      <table>
      <tr>
                <th colspan="5"> <i class='bx bxs-user-circle'>  <b> <?php echo $row1['fname']." ".$row1['lname']; ?> </b></i> <a href="view.php"><button  class="add-btn"> &nbsp; Update Profile</button></a></th>
            </tr>
            <BR><BR>
    <tr>
      <th> Name : </th>
