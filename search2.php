...
?>
            <a  href='now1.php?num=<?php echo $row['centre_id']; ?>'> <button class="view-btn" style="padding: 7px 40px; border: none; font-size: 15px; border-radius: 3px; background: green; cursor: pointer; opacity: 0.8;">Schedule now</button></a> 
        <?php
                }
            }
                else
