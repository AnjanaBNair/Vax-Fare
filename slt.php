  ...
  if(isset($_POST["sub"]))
	{
		$st=$_POST["start"];
		$ed=$_POST["end"];
    $query2="select * from tbl_slot where centre='$id';";
    $re2=mysqli_query($con,$query2);
    $count=mysqli_num_rows($re2);
    if($count>0)
    {
      $q1="update tbl_slot set sdtime='$st' and edtime='$ed' where centre='$id';";
		$res1=mysqli_query($con,$q1);
    }
    else
    {
      $q="insert into tbl_slot(centre,sdtime,edtime) values ('$id','$st','$ed');";
...
<td> <input type="datetime-local" id="enddatetime" name="end" min="" required></td>
</tr>
...
<script>$(document).ready(function() {
    ...
    // Initialize datepicker with tomorrow's date as default
