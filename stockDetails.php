...
<body>
  ...
  <section class="home-section">
    ...
    <div class="container">
   <div class="cls"> <a href="stockAvail.php"><button  class="view-btn"> &nbsp;<i class='bx bxs-info-circle'> Availability Details</i></button></a>
</div><br>
    <table>
        <thead>
        <tr>
                <th colspan="7"><b>Stock Details</b><a href="stockAdmin.php"><button  class="add-btn"> &nbsp;<i class='bx bx-plus'>Renewal</i></button></a> 
                </th>
            </tr>
        </thead>
        <tbody>
      ...
      {
        $id=$row['vaccine'];
      $query1="select * from tbl_vaccine where status='1' and vaccine_id='$id';";
      $re1=mysqli_query($con,$query1);
        
      $d=$row['distributer'];
      $query="select * from tbl_distributer where status='1' and id='$d';";
        ...
        ?>
            <tr>
              <td><?php echo  $i++; ?></td>
                ...
                <td> <?php echo $row['stock_renew'] ;?></td>
