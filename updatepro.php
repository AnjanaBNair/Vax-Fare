<?php
  session_start();
    ...
    $mob=$_POST['mob'];
		...
		$query="update tbl_user set fname='$fn',lname='$ln',mobileno='$mob'  where id='$lid'" ;
...
<?php
$q="select * from tbl_user where lid='$_SESSION['uid']';";
...
?>
          <div class="row">
            ...
            <div class="col-75">
            <input type="text" value="<?php echo $rw['fname']; ?>"placeholder="Enter First Name" name="fname" id="p1" required/>
            <span> <p id="error1"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Letters allowed.</b></p></span>
            </div>
          </div><br>
          ...
          <div class="row">
            <div class="col-25">
              <label for="lname">lname Name</label>
            </div>
            <div class="col-75">
            <input type="text" placeholder="Enter Last Name" name="lname" id="p2" required/>
            <span> <p id="error2"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Letters allowed.</b></p></span>
            </div>
          </div><br>
          ...
          <div class="row">
            ...
            <div class="col-75">
            <input type="password" placeholder="Enter new Password" name="pass1" id="p2" required/>
              <span>
          ...
          <div class="row">
            ...
            <div class="col-75">
            <input type="password" placeholder="Confirm Password" name="pass2" id="p3" required/>
              <span>
              <p id="error3"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Password Doesn't Match</p><br>
              </span>
            </div>
          </div>
