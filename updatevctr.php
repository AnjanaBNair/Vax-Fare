<?php 
    ...
    {
      $id=$_SESSION['uid'];
			$query="select * from tbl_vaccinator  where lid='$id';";
...
if(isset($_POST["sub"]))
	{
		...
		$lna=$_POST["lname"];
		$mb=$_POST["mob"];
		$q="update tbl_vaccinator set fname='$fna',lname='$lna',mob='$mb' where lid='$id'";
		$res=mysqli_query($con,$q);
			...
			header('Location: vctrprofile.php');
		}
		mysqli_close($con);
	  ...
	  <div>
         ...
         <input type="text" placeholder="Enter First Name" value="<?php echo $row['fname'];?>" name="fname" id="p1" required/>
		  ...
		  <p id="error2"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Name </p><br>
			...
			<div class="input-box">
          <input type="text" placeholder="Enter Mobile Number" value="<?php echo $row['mob'];?>" name="mob" id="p4" required/>
