...
<?php 
    ...
    if(isset($_POST["sub"]))
    {
      ...
      $query4="select * from tbl_vaccine where vaccine='$vacc'";
      $re4=mysqli_query($con,$query4);
      $count=mysqli_num_rows($re4);
      if($count>0)
      {
        $query5="update tbl_vaccine set status=1 where vaccine='$vacc'";
        $re5=mysqli_query($con,$query5); 
        header('Location: VaccineTable.php');
      }
      else
      {
        $query="insert into tbl_vaccine(vaccine,status) values('$vacc','1')";
...
<script src="http://code.jquery.com/ui/1.9.1/jquery-ui.js"></script>
	...
	var v6=0;
        $(document).ready(function () {
            ...
            var  name= /^[a-zA-Z\s]*$/;
            $("#vaccine").keyup(function () {
                x = document.getElementById("vaccine").value;
            ...
            var  manufact= /^[a-zA-Z\s]*$/;
            $("#man").keyup(function () {
                x = document.getElementById("man").value;
                if (manufact.test(x) == false) {
                     v1 = 1;
                    $("#error2").show();
                }
                else if (manufact.test(x) == true) {
                   v1 = 0;
                    $("#error2").hide();
                }
            });
			...
			var no = /^[789]|10$/;
			$("#cap").keyup(function () {
                x = document.getElementById("cap").value;
                if (no.test(x) == false) {
                    v3 = 1
                    $("#error3").show();
                }
                else if (no.test(x) == true) {
                   v3 = 0
                    $("#error3").hide();
                }
            });
...
<div class="sidebar">
  ...
  <form method="post">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="vaccine" name="vaccine" placeholder="Vaccine Name" required/>
