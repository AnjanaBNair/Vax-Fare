...
if(isset($_SESSION['uid']))
    {
    $id= $_GET['emp'];
  $query = "select * from tbl_vaccinator where emp='$id';";
  ...
  $query3="select * from tbl_login where status='2' and id='$lid';";
  $re3=mysqli_query($con,$query3);
  $row3=mysqli_fetch_array($re3);
  $query4="select * from tbl_centre where status='1' and centre_id='$c_id';";
  $re4=mysqli_query($con,$query4);
  $row4=mysqli_fetch_array($re4);
  $qy = "select * from tbl_role where role_id='$role';";
  $r1 = mysqli_query($con, $qy);
...
<body>
  ...
  <section class="home-section">
    ...
    <div class="container">
      <table>
      <tr>
                <th colspan="5"> <i class='bx bxs-user-circle'>  <b> <?php echo $row['fname']." ".$row['lname']; ?> </b></i> <a href="VctrView.php"><button  class="add-btn"> &nbsp;<i class='bx bx-arrow-back'> Back </i></button></a></th>
            </tr>
            <BR><BR>
      <tr>
      <th> Employee Id : </th>
  ...
  <tr>
      <th>Address: </th>
      <td> <?php echo $row['house'] ?> <br><?php echo $row1['name'] ?>
      <br><?php echo $row2['name'] ?>
    </td>
  </tr>
  <tr>
